		    ...
		    <ul>
		      <li class="ncs-info-btn-map">
		        <a href="javascript:void(0)" class="pngFix">
			        ...
			        <div class="ncs-info-map" id="map_container" style="width:198px;height:320px;">
			      		  地图加载中... 
			        </div>
		        </a>
		      </li>
		      <li class="ncs-info-btn-qrcode" style="border-left:none;">
		      <a href="javascript:void(0)" class="pngFix">
		            <span>
		          	店铺二维码
		            </span><b></b> <!-- 店铺二维码 -->
			        <p class="ncs-info-qrcode">
			        		<img src="${imgServer}${storeVo.storeCode}"  title="" onload="javascript:DrawImage(this,150,150);">
			        		<em>手机扫描二维码<br/>快速收藏店铺</em>
			         </p>
		        </a> 
		      </li>
		    </ul>
