	...
	<div class="content">
		...
		<div class="pagination">
		   	<#--获取总条数-->
				...
				<#if recordCount??>
				    <@q.pager pageNo=pageNo pageSize=pageSize recordCount=recordCount  toURL="${toUrl}?orderField="+'${orderField}'+"&order="+'${order}'+"&storeClassId="+'${storeClassId}'+"&goodsName="+'${goodsName}'/>
				</#if>
		</div>
		<div class="clear"></div>
	</div>
