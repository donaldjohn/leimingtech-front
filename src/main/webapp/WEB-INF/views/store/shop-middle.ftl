			      ...
			      <#list recommendgoodslist as recommendgoods>
			          <li>
		                <dl>
		                  ...
		                  <dd class="ncg-pic pngFix"><a href="${base}/leimingtech-front/product/detail?id=${recommendgoods.goodsId}" target="_blank" class="thumb"><i></i><img src="${imgServer}${recommendgoods.goodsImage}" onload="javascript:DrawImage(this,160,160);" title="${recommendgoods.goodsName}" alt="${recommendgoods.goodsName}" /></a></dd>
			      ...
			      <#list newProductlist as newGoods>
			          <li>
		                <dl>
		                  ...
		                  <dd class="ncg-pic pngFix"><a href="${base}/leimingtech-front/product/detail?id=${newGoods.goodsId}" target="_blank" class="thumb"><i></i><img src="${imgServer}${newGoods.goodsImage}" onload="javascript:DrawImage(this,160,160);" title="${newGoods.goodsName}" alt="${newGoods.goodsName}" /></a></dd>
		                  <dd class="ncg-price"><em class="price"><i>&yen;</i>
