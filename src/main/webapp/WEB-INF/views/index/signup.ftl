...
<head>
    ...
    <title>LmShop B2B2C V3.0 2015版商城系统-注册</title>
                ...
                <form id="register_form" method="post" action="">
                    ...
                    <dl>
                        ...
                        <dd>
                            ...
                            <span for="clause" class="fl ml5">阅读并同意<a href="${base}/document/forward?id=1" target="_blank" class="agreement" title="阅读并同意">服务协议</a></span>
                            <label></label>
                        </dd>
                    </dl>
