...
<div class="home-focus-layout">
	<!-- 首页大广告 -->
 	...
 	<ul id="fullScreenSlides" class="full-screen-slides">
   		...
   		<a href="${advs.advUrl}" target="_blank"><img class="scrollLoading" src="${imgServer}${advs.resUrl}" data-url="${imgServer}${advs.resUrl}" alt="${advs.advTitle}" width="770" height="300" style="display: inline;"></a>
   		</li>
   	 	</#list>
  	</ul>
               	...
               	<#list youlikeGoodslist as youlikeGoods >
                      <li>
                    	<dl>
	                        ...
	                        <!--商品价格-->
	                        <dd class="goods-price"> 商城价：<em>&yen;${youlikeGoods.goods.goodsStorePrice}</em></dd>
	                    </dl>
               		</li>
	    ...
	    <#list json as item>
				            ...
				            <#elseif (goods_index=2)>
					         ...
					         <#elseif (goods_index>4 &&goods_index<9)>
					         	<li class="d${dg}" style="opacity: 1;">
						            <a href="${base}/product/detail?id=${goods.goodsId}" target="_blank">
						            <img style="width: 194px; height: 110px; display: inline;" border="0" class="scrollLoading" src="${imgServer}${goods.goodsImage}" 
		    ...
		    <div class="right-sidebar">
		        ...
		        <div class="right-side-focus">
		            ...
		            <#assign floorAdvs = advPositionTag("{'apKey':'floor${webCode_index+1}'}") />
				    	<#if floorAdvs?? && floorAdvs!''>
				        <#assign floors = floorAdvs.advList />
					       <#if floors??>
					       <#list floors as floor >
				            <li><a href="${floor.advUrl}" target="_blank"><img class="scrollLoading" src="${imgServer}${floor.resUrl}" 
				            data-url="${imgServer}${floor.resUrl}" alt="" width="212" height="241" style="display: inline;"></a>
				            </li>
		            		<#if (floor_index>1)><#break></#if>
			       			</#list>
				       	   </#if>
				       </#if>
		            </ul>
