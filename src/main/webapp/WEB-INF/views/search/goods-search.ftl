		    	...
		    	<#list lucenePage.result as goods>
			        <li class="item">
				      <div class="goods-content" nctype_goods="${goods.goodsId}" nctype_store="${goods.storeId}">
				        ...
				        <img src=<#if goods.goodsImage??>"${imgServer}${goods.goodsImage}_${imageSet.big_pic_width}x${imageSet.big_pic_height}.${(goods.goodsImage?split("."))[goods.goodsImage?split(".")?size-1]}"<#else>"${base}/res/images/common/default_goods_image.gif_small.gif"</#if> title="${goods.goodsName}" alt="${goods.goodsName}"></a>
						</div>
						 <div class="goods-info" style="top: 230px;">
							<div class="goods-pic-scroll-show">
								...
								<#list goods.goodsImageMore?split(",") as image>
									<#if image!=''>
					                	<li><a href="javascript:void(0);"><img src="${imgServer}${image}_${imageSet.tiny_pic_width}x${imageSet.tiny_pic_height}.${(image?split("."))[image?split(".")?size-1]}" alt="" onload="javascript:DrawImage(this,60,60);"></a></li>
									</#if>
									<#if image_index==4>
										<#break>
									</#if>
				         ...
				         <div class="goods-name">
				         	<a href="${base}/product/detail?id=${goods.goodsId}" target="_blank" title="${goods.goodsName}">${goods.goodsName}<br/><span style="color:#f30;">${goods.goodsSubtitle}</span></a>
						 </div>
				        ...
				        <div class="sell-stat">
				            <ul>
				              <li>
				              <a href='${base}/product/detail?id=${goods.goodsId}&tab=1' target="_blank" class="status">${goods.salenum}</a><p>商品销量</p>
							  </li>
				              <li>
				              <a href='${base}/product/detail?id=${goods.goodsId}&tab=2' target="_blank">${goods.commentnum}</a><p>用户评论</p>
							  </li>
							  <li>
...
<script type="text/javascript">
	...
	var small = "${imageSet.tiny_pic_width}x${imageSet.tiny_pic_height}"; 
	var big = "${imageSet.big_pic_width}x${imageSet.big_pic_height}";
	//浮动导航  waypoints.js
