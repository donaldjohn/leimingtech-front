...
<title>LmShop B2B2C V3.0 2015版商城系统</title>
...
<div class="phone_main">
  ...
  <div class="logo_line">
	  <img src="${base}/res/html5/images/logo.png" width="250" height="33"/> 
	  	<@shiro.guest>
	    	<a class="log" href="${base}/m/index/login">登陆</a>
	    </@shiro.guest>
	   	<@shiro.user>
	   		<a class="log" href="${base}/m/authc/buyer/center"><@shiro.principal/></a>
	   		<a class="log" href="${base}/m/index/logout">退出</a>
 		</@shiro.user>
  </div>
  <form name="theForm" id="theForm" action="" method="post">
    <div class="search_line"><span>
      ...
      <b>
        <a href="javascript:void(0)" onclick="searcht();"><img src="${base}/res/html5/images/search_icon.png" width="25" height="25" id="search" /></a>
       </b>
      </div>
  </form>
  <!--幻灯-->
