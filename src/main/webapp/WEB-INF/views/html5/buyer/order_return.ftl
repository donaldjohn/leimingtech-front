...
<div class="order_page">
		...
		<table class="trade_table" cellpadding="0" cellspacing="0">
	    	<tbody>
	        	<tr>
	            	<td class="td_left"><img src="/leimingtech-front/res/html5/images/order_info_01.png" width="30" height="30" /></td>
	                <td>
	                	<ul>
			        ...
			        <div class="dd dd_01">
			         ...
			         <div class="dd dd_01">
						...
						<label>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							本次退货：&nbsp;
							<input type="text" id="returnGoodsNum" name="returnGoodsNum" value="${orderGoods.goodsNum}" value="${orderGoods.goodsNum}"  onChange="change(this)"/>            
				  		</label>
				        </span>
				        <span class="size"> </span>
			         </div>
