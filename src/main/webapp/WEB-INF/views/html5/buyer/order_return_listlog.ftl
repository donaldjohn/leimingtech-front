   ...
   jQuery(window).scroll(function(){								  
	 if (jQuery(document).scrollTop() >= jQuery(document).height() - jQuery(window).height()&&ret==1) {
		...
		jQuery.ajax({type:'POST',
	              url:'http://b2b2c.iskyshop.com/wap/buyer/order_return_listlog.htm',
...
<div class="phone_main">
    ...
    <div class="order_return_list">
    	<ul class="resturn_tab">
            ...
            <li><a href="${base}/m/authc/buyer/groupLifeRreturn">生活购退款</a></li>
...
<ul>
  <li><img src="${base}/res/html5/images/loading.png" width="16" height="16" /></li>
  <li>正在加载....</li>
</ul>
</div>
...
<div class="layer">
    ...
    <div class="layer_show" id="show" mark="hide" style="display:none">
    	<ul>
            ...
            <li><a href="${base}/m/authc/buyer/orderlist"><img src="${base}/res/html5/images/layer_02.png" width="20" height="20" /><p>订单</p></a></li>
