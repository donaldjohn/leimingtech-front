...
<title>${goods.goodsName} - LmShop B2B2C V3.0 2015版商城系统</title>
...
<script>
	...
	jQuery(function() {
		...
		jQuery("#show_spec").click(function(e) {
			if(jQuery("#spec_count").css("display")=="block"){
				jQuery("#img_spec").attr("src","http://b2b2c.iskyshop.com/resources/style/system/front/wap/images/details_right.gif");
			...
			jQuery("#show_count").html("x"+jQuery("#count").val());
				...
				jQuery("#img_spec").attr("src","http://b2b2c.iskyshop.com/resources/style/system/front/wap/images/details_right_b.gif");
	...
	function goods_spec_set(obj){
		...
		if(load){
		jQuery.post("http://b2b2c.iskyshop.com/wap/load_goods_gsp.htm",{"id":"11","gsp":gsp},function(data){
	  ...
	  <div class="details_top">
		    ...
		    <section>
		      <div class="details_price" style="height:45px;">
		        ...
		        <span> 
		       	 	<#if '${isCollection}'==0>
			       	 	<a id="a_product" href="javascript:void(0)"  onclick="collect_storeorgoods('${goods.goodsId}','1','${goods.storeId}');" class="details_star">
		                	<img id="img_product" src="${base}/res/html5/images/star_bg.png" mark="0">商品
		                </a>
	                <#else>
		                <a id="a_product" href="javascript:void(0)"  onclick="deletefavotitegoods('${goods.goodsId}','1','${goods.storeId}');" class="details_star">
