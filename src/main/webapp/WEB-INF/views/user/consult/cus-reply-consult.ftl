...
<div id="container" class="wrapper">
	<div class="layout">
		    ...
		    <script type="text/javascript">
      		...
      		<div class="business-handle" id="my_menu">
        		...
        		<dl class="collapsed">
					...
					<dd class='normal'><a href="${base}/myuser/storeFavList">收藏店铺</a></dd>
                </dl>
                <dl class="collapsed">
    	...
    	<div class="right-content">
      		<div class="path">
        		<div>
        			<a href="#?act=member_snsindex">我的商城</a><span>&raquo;</span>
				...
				<div class="wrap">
  					<div class="tabmenu">
    					<ul class="tab pngFix">
  							...
  							<li class="normal"><a  href="${base}/myconsult/noreplyConsultList">未回复咨询</a></li>
  							<li class="active"><a  href="#">已回复咨询</a></li>
  						</ul>
  					</div>
  					<table class="ncu-table-style order">
    					...
    					<tbody>
      						...
      						<tr>
        						<th colspan="20">
        							<span class="ml10">
        								<a href="#?act=goods&goods_id=88" target="_blank">李宁运动鞋</a>
        							</span>
        							<span class="ml20">
        								咨询时间：<em class="goods-time">2015-06-26 14:56:57</em>
        							</span>
        						</th>
      						</tr>	
      						<tr>
        						...
        						<td class="tl">
        							<strong>咨询内容：</strong>
        							<span class="gray">111111111</span>
        						</td>
        						<td class="bdr"></td>
        					</tr>
              				<tr>
	        					...
	        					<td class="tl">
	        						<strong>回复时间：</strong>
	        						<span class="gray">的飒飒</span>
	        						<span class="ml10 goods-time">(2015-06-26 14:58:14)</span>
	        					</td>
	        					<td class="bdr"></td>
	      					</tr>
						</tbody>
