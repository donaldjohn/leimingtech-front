...
<div id="container" class="wrapper">
	<div class="layout">
		...
		<div class="right-content">
			<div class="path">
				<div>
					<a href="${base}/user/index">买家中心</a><span>&raquo;</span>
				...
				<div class="wrap">
					...
					<div class="ncu-form-style">
						<form method="post" id="profile_form" action="">
							...
							<dl>
								<dt class="required"><em class="pngFix"></em>真实姓名：</dt>
								<dd>
									<p>
										<input type="text" class="text" maxlength="30" name="memberTruename" id="memberTruename" value="${member.memberTruename}" />
									</p>
						    ...
						    <dl>
								<dt>生日：</dt>
								<dd>
									<input onfocus="WdatePicker({maxDate: '%y-%M-{%d-1}' })" class="txt Wdate" type="text" value="<#if member.memberBirthdaystr??>${member.memberBirthdaystr?string("yyyy-MM-dd")}</#if>" id="memberBirthday" name="Birthday" style="width: 151px;height: 18px;"/>
								</dd>
							</dl>
							<dl>
