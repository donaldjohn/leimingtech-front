...
<div id="container" class="wrapper">
	<div class="layout">
    	...
    	<div class="right-content">
      		<div class="path">
        		<div><a href="${base}">我的商城</a><span>&raquo;</span></div>
      		</div>
      		<div class="main">
				...
				<div class="wrap">
  					<div class="layout-l">
   						<div class="member-intro">
      						<dl>
        						<dt class="nc-member-name"><a href="${base}/user/setting/index" title="编辑用户信息">${member.memberName}</a>&nbsp;(${member.memberName})</dt>
        						<dd>买家信用${member.memberCredit}</dd>
                				<dd>积分数&nbsp;<strong>
					    ...
					    <ul class="release-tab">
					      	...
					      	<li class="sharestore" id="snssharestore"><em></em><a href="javascript:void(0)">分享店铺</a></li>
					    </ul>
    					...
    					<div class="tabmenu" style="z-index:0;">
      						<ul class="tab pngFix">
        						<li class="active" nctype="friendtrace"><a id="tabGoodsIntro" href="javascript:void(0)" ><span>好友动态</span></a></li>
       							<li class="normal" nctype="storetrace"><a href="javascript:void(0)" ><span>店铺动态</span></a></li>
      						</ul>
    					</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#snssharestore').click(function(){
		    ajax_form("sharestore", '分享店铺', 'http://192.168.1.230/#?act=member_snsindex&op=sharestore&irefresh=1', 500);
		    return false;
		});
        //加载好友动态分页
