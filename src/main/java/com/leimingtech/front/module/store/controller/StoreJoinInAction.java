package com.leimingtech.front.module.store.controller;
...
//        try {
//            Map<String,Object> map = com.leimingtech.core.common.FileUtils.fileUpload(file4,
...
//        try {
//            Map<String,Object> map = com.leimingtech.core.common.FileUtils.fileUpload(file0,
//                    CommonConstants.FILE_BASEPATH,Constants.LOGO_UPLOAD_URL);
...
//        try {
//            Map<String,Object> map = com.leimingtech.core.common.FileUtils.fileUpload(file1,
//                    CommonConstants.FILE_BASEPATH,Constants.LOGO_UPLOAD_URL);
...
//        try {
//            Map<String,Object> map = com.leimingtech.core.common.FileUtils.fileUpload(file2,
//                    CommonConstants.FILE_BASEPATH,Constants.LOGO_UPLOAD_URL);
...
//        try {
//            Map<String,Object> map = com.leimingtech.core.common.FileUtils.fileUpload(file3,
//                    CommonConstants.FILE_BASEPATH,Constants.LOGO_UPLOAD_URL);
...
//        try {
//            Map<String, Object> map = com.leimingtech.core.common.FileUtils.fileUpload(file,
//                    CommonConstants.FILE_BASEPATH, Constants.LOGO_UPLOAD_URL);
